...
export const USER_AGENTS = {
  Mechanize:
    `Mechanize/${VERSION} Node.js/${process.version} ` +
    '(http://github.com/srveit/mechanize-js/)',
  'Linux Firefox':
    'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:43.0) ' +
  ...
  'Mac Safari 4':
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_2; de-at) ' +
  ...
  'Windows Firefox':
    'Mozilla/5.0 (Windows NT 6.3; WOW64; rv:43.0) ' +
    'Gecko/20100101 Firefox/43.0',
  iPhone:
  ...
  iPad:
    ...
    'Safari/601.1',
  Android:
    'Mozilla/5.0 (Linux; Android 5.1.1; Nexus 7 Build/LMY47V) ' +

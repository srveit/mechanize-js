...
Page.prototype.__defineGetter__('responseHeaderCharset', function () {
  ...
  Object.keys(headers).forEach(function (header) {
    ...
    if (header) {
      ...
      m = value && /charset=([\-().:_0-9a-zA-z]+)/.exec(value);    // eslint-disable-line no-useless-escape
      if (m) {
        charsets.push(m[1]);
      }
    }
...
Page.prototype.statusCode = function (xpath) {          // eslint-disable-line no-unused-vars
